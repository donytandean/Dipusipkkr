...
<div class="container">
    ...
    <h1 class="text-center">TAMBAH KONTAK</h1>
    <ul>
    <form action="" method="post" enctype="multipart/form-data">

    <input class="form-control" type="text" name="no_hp" id="no_hp" size="40" autofocus placeholder="silakan masukkan nomor hp/telepon.... " autocomplete="off" required>
    <br>
    <input class="form-control" type="text" name="email" id="email" size="40" autofocus placeholder="silakan masukkan alamat email anda.... " autocomplete="off" required>
    <br>
    <input class="form-control" type="text" name="ig" id="ig" size="40" autofocus placeholder="silakan masukkan media sosial instagram anda.... " autocomplete="off" required>
    <br>
    <input class="form-control" type="text" name="fb" id="fb" size="40" autofocus placeholder="silakan masukkan media sosial facebook anda.... " autocomplete="off" required>
    <br>
    <input class="form-control" type="text" name="tw" id="tw" size="40" autofocus placeholder="silakan masukkan media sosial twitter anda.... " autocomplete="off" required>
    <br>
    <button type="submit" name="submit" class="btn btn-info text-light tombol">Tambah Data Kontak</button>
    </form>
    </ul>
    </div>
    <!-- akhir konten -->
    ...
    <h1 class="text-center mt-5 pt-5">KONTAK</h1>
    <br><br>
        ...
        <table class="table table-bordered table-hover table-light" border="1" cellpadding="10" cellspacing="0">
			...
			<tr class="text-center">
                ...
                <td><?= $row["tw"]; ?></td>
				<td>
					<a href="ubahkon.php?id=<?= $row["id"]; ?>" class="btn btn-info tombol text-light">Ubah</a>
					<a href="hapuskon.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin ingin menghapus kontak ?');" class="btn btn-danger">Hapus</a>
				</td>
			</tr>
			<?php $i++; ?>
			<?php endforeach; ?>
