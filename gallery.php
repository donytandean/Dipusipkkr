...
<div class="container">
    ...
    <h1 class="text-center">TAMBAH GAMBAR</h1>
    <ul>
    <form action="" method="post" enctype="multipart/form-data">

    <input type="file" name="gambar" id="gambar">
    <br><br>
    <input class="form-control" type="text" name="namakeg" id="namakeg" size="40" autofocus placeholder="silakan masukkan nama kegiatan/gambar.... " autocomplete="off" required>
    <br>
    <input class="form-control" type="text" name="capt" id="capt" size="40" autofocus placeholder="silakan masukkan keterangan kegiatan/gambar.... " autocomplete="off" required>
    <br>
    <input class="form-control" type="text" name="tahunkeg" id="tahunkeg" size="40" autofocus placeholder="silakan masukkan tahun kegiatan/gambar.... " autocomplete="off" required>
    <br>
