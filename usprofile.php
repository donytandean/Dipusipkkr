...
// $vimi = query("SELECT * FROM visimisi");
...
<!--Jumbotron -->
	<div class="jumbotron jumbotron-fluid">
		<div class="container">
			<h1 class="display-4">Profile Ini Menceritakan Tentang Sejarah, Struktural, dan Masih Banyak Lagi Tentang Dinas Perpustakaan dan Kearsipan Kabupaten Kubu Raya</h1>
		</div>
	</div>
<!--Akhir Jumbotron -->
