...
$gall = query("SELECT * FROM gallery WHERE id = $id")[0];
...
<div class="container">
    ...
    <h1 class="text-center">UBAH DATA GAMBAR</h1>
    <ul>
    <form action="" method="post" enctype="multipart/form-data">

    <input type="hidden" name="id" value="<?= $gall["id"]; ?>">
    <input type="hidden" name="gambarLama" value="<?= $gall["gambar"]; ?>">

    <img src="gambar/<?= $gall["gambar"]; ?>" width="300"><br><br>
    <input type="file" name="gambar" id="gambar">
    <br><br>

    <input class="form-control" type="text" name="namakeg" id="namakeg" size="40" autofocus placeholder="silakan masukkan nama kegiatan/gambar.... " autocomplete="off" value="<?= $gall["namakeg"]; ?>" required>
    <br>
    <input class="form-control" type="text" name="capt" id="capt" size="40" autofocus placeholder="silakan masukkan keterangan kegiatan/gambar.... " autocomplete="off" value="<?= $gall["capt"]; ?>" required>
    <br>
    <input class="form-control" type="text" name="tahunkeg" id="tahunkeg" size="40" autofocus placeholder="silakan masukkan tahun kegiatan/gambar.... " autocomplete="off" value="<?= $gall["tahunkeg"]; ?>" required>
    <br>
    ...
    <h1 class="text-center mt-5 pt-5">DATA GAMBAR</h1>
    <br><br>
        ...
        <table class="table table-bordered table-hover table-light" border="1" cellpadding="10" cellspacing="0">
			...
			<tr class="text-center">
				...
				<td><?= $row["tahunkeg"]; ?></td>
				<td>
					<a href="ubahgal.php?id=<?= $row["id"]; ?>" class="btn btn-info tombol text-light">Ubah</a>
					<a href="hapusgal.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin ingin menghapus kegiatan ?');" class="btn btn-danger">Hapus</a>
				</td>
			</tr>
			<?php $i++; ?>
			<?php endforeach; ?>
