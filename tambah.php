...
<div class="container">
    ...
    <input class="form-control" type="text" name="judul" id="judul" placeholder="Judul Buku" required>
    <br>
    <input class="form-control" type="text" name="jumlah" id="jumlah" placeholder="Jumlah Buku" required>
    <br>
    <input class="form-control" type="text" name="edisi" id="edisi" placeholder="Edisi" required>
    <br>
    <input class="form-control" type="text" name="isbn" id="isbn" placeholder="Isbn" required>
    <br>
    <input class="form-control" type="text" name="penerbit" id="penerbit" placeholder="Penerbit" required>
    <br>
    <input class="form-control" type="text" name="tahun_terbit" id="tahun_terbit" placeholder="Tahun Terbit" required>
    <br>
    <input class="form-control" type="text" name="jumlah_hal" id="jumlah_hal" placeholder="Jumlah Halaman" required>
    <br>
    <input class="form-control" type="text" name="panjang_lebar" id="panjang_lebar" placeholder="Panjang x Lebar Buku" required>
    <br>
    <input class="form-control" type="text" name="judul_seri" id="judul_seri" placeholder="Judul Seri" required>
    <br>
    <input class="form-control" type="text" name="no_panggilan" id="no_panggilan" placeholder="Nomor Panggilan" required>
    <br>
    <input class="form-control" type="text" name="tempat_terbit" id="tempat_terbit" placeholder="Tempat Terbit" required>
    <br>
    <input class="form-control" type="text" name="klasifikasi" id="klasifikasi" placeholder="Klasifikasi" required>
    <br>
    <input class="form-control" type="text" name="pengarang" id="pengarang" placeholder="Pernyataan Tanggung Jawab (Pengarang)" required>
    <br>
    <br><br>
    <button type="submit" name="submit" class="btn btn-info text-light tombol">Tambah Data</button>
    </form>
    </ul>
    </div>
    <!-- akhir konten -->
