...
<div class="container">
	...
	<div class="row workingspace">
        <?php $i = 1; ?>
		<?php foreach($kont as $row) : ?>
		<div class="col-lg-6">
			<img src="img/kb.png" alt="workingspace" class="img-fluid">
		</div>
		<div class="col-lg-6 text-align: center;">
			<h3><span>Kontak Dinas Perpustakaan dan Kearsipan Kubu Raya</span></h3>
			<h4>Telepon     : <?= $row["no_hp"]; ?></h4>
            <h4>E-Mail      : <?= $row["email"]; ?></h4>
            <h4>Instagram   : <?= $row["ig"]; ?></h4>
            <h4>Facebook    : <?= $row["fb"]; ?></h4>
            <h4>Twitter     : <?= $row["tw"]; ?></h4>
            <br>
				<a href="" class="btn btn-danger tombol mb-5">Nonton Youtube DIPUSIPKKR</a>
		</div>
        <?php $i++; ?>
		<?php endforeach; ?>
	</div>
